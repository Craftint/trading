frappe.ui.form.on('Purchase Order Item', 'history', function(frm,cdt,cdn) {
	var d = locals[cdt][cdn]
	frappe.set_route('query-report', 'Item-wise Purchase Register', {item_code: d.item_code});
})

frappe.ui.form.on('Purchase Order', 'transaction_date', function(frm,cdt,cdn) {
...
frappe.ui.form.on('Purchase Order Item', {
        item_code:function(frm,cdt,cdn){
		 ...
		 console.log(d.item_name);
              ...
              // frm.set_value( "item_name_detail", d.item_name);
		console.log(d.item_name);
