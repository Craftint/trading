...
def get_columns():
    columns = [
        ...
        {"label": _("Item"), "fieldname": "item_name", "width": 200},
        {"label": _("Balance Qty"), "fieldname": "qty_after_transaction",
         "fieldtype": "Float", "width": 100, "convertible": "qty"},
        {"label": _("Incoming Price"), "fieldname": "rate_recvd", "fieldtype": "Currency", "width": 130,
         "options": "Company:company:default_currency", "convertible": "rate"},
        {"label": _("Outgoing Price"), "fieldname": "rate_issued", "fieldtype": "Currency", "width": 110,
         "options": "Company:company:default_currency", "convertible": "rate"},
